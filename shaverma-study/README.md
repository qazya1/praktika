...
Платежи, чеки, QR, бонусы, рефералы, несколько заведений, сложные директорские таблицы, фоновые очереди уведомлений, миграции боевой БД, загрузка изображений и расширенная аналитика. Для задания достаточно базового цикла: **меню → корзина → заказ → обработка сотрудником**.
